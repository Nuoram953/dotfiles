...
-- Quickfix list
vim.keymap.set( "n", "<leader>qn", "<cmd>cnext<CR>", { desc = "Go to next element Quickfix", noremap = true, silent = true })
vim.keymap.set( "n", "<leader>qp", "<cmd>cprev<CR>", { desc = "Go to previous element Quickfix", noremap = true, silent = true })
vim.keymap.set( "n", "<leader>qln", "<cmd>lnext<CR>", { desc = "Go to next list element Quickfix", noremap = true, silent = true })
vim.keymap.set( "n", "<leader>qlp", "<cmd>lprev<CR>", { desc = "Go to previous list element Quickfix", noremap = true, silent = true })

--lsp
vim.keymap.set( "n", "<leader>dq", "<cmd>lua vim.diagnostic.setloclist()<CR>", { desc = "Send lsp to Quickfix list", noremap = true, silent = true })
vim.keymap.set( "n", "<leader>dn", "<cmd>lua vim.diagnostic.goto_next()<CR>", { desc = "Go to next element diagnostic", noremap = true, silent = true })
vim.keymap.set( "n", "<leader>dp", "<cmd>lua vim.diagnostic.goto_prev()<CR>", { desc = "Go to previous element Quickfix", noremap = true, silent = true })
